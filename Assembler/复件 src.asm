	8'd0: instr_code <= 8'bxxxxxxxx; //ldo r4, r?			(p_i, ?)
	8'd0: instr_code <= 8'bxxxxxxxx; //tstz r?
	8'd0: instr_code <= 8'bxx001010; //jz @p_ni
	8'd0: instr_code <= 8'bxxxxxxxx; //ldo r5, r?			(q_i, ?)
	8'd0: instr_code <= 8'bxxxxxxxx; //tstz r?
	...
	8'd0: instr_code <= 8'bxxxxxxxx; //p_ni//ldo r5, r?	(q_i, ?)
	8'd0: instr_code <= 8'bxxxxxxxx; //tstz r?
	...
	8'd0: instr_code <= 8'bxx010111; //jnz COMMON
